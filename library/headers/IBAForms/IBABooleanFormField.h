...
@property (nonatomic, assign) NSString *checkCellTitle;
...
- (id)initWithKeyPath:(NSString *)keyPath title:(NSString *)title checkCellTitle:(NSString *) title type:(IBABooleanFormFieldType)booleanFormFieldType;
